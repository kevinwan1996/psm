                ...
                <div class="contentWidth">
                    ...
                    <div class="tabSection">
                            ...
                            <div class="section" id="updateProfile">
                                <div class="wholeCol">
                                    ...
                                    <div class="row">
                                        ...
                                        <c:set var="errorCls" value="" />
                                        <spring:bind path="lastName"><c:if test="${status.error}"><c:set var="errorCls" value="errorInput" /></c:if></spring:bind>
                                    ...
                                    <div class="row">
                                        ...
                                        <c:set var="errorCls" value="" />
                                        <spring:bind path="firstName"><c:if test="${status.error}"><c:set var="errorCls" value="errorInput" /></c:if></spring:bind>
                                    ...
                                    <div class="row">
                                        ...
                                        <c:set var="errorCls" value="" />
                                        <spring:bind path="middleName"><c:if test="${status.error}"><c:set var="errorCls" value="errorInput" /></c:if></spring:bind>
                        ...
                        <div class="buttonBox">
                            ...
                            <a href="javascript:submitFormById('registrationform');" class="purpleBtn"><span class="btR"><span class="btM">Register</span></span></a>
                        </div>
                        <!-- /.buttonBox -->
                        </form:form>
                    </div>
